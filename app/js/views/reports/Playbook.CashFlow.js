define(['BaseReport', 'views/reports/CashFlowDetail', 'i18n!nls/CashFlow.i18n', 'Config'],

    function(BaseReport, CashFlowDetail, CF_localizable, config) {

        var view = CashFlowDetail.extend({

            reportName: 'Playbook.CashFlow',
            ...
            initialize: function(router, startDate) {
                ...
                // call super
                CashFlowDetail.prototype.initialize.call(this, router, CF_localizable);
                this.router = router;
            },
            ...
            load: function(callback) {
                ...
                return $.ajax({
                    ...
                    .done(function(response, textStatus, jqXHR) {
                        ...
                        self.loadCashFlowDetail(response, "MMM[linefeed]YYYY");
