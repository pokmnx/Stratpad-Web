...
# see 'Lawyers' in Google Drive - https://docs.google.com/spreadsheets/d/1cxwFCt8r3U9V96-GlZK5qJX-OrpXyCBdOm-S0h_uFVY/edit?usp=sharing
login(server, 'root@stratpad.com', 'StratP@d')
with open ('/Users/woodj/Documents/projects/jstratpad/src/main/resources/banks/Lawyers - legal.csv', 'rb') as csvfile:
