...
# see 'Accountants' in Google Drive - https://docs.google.com/spreadsheets/d/1EqDETHV3MSY5LB8B_BAfSGEgHIwTnBt0OBOj7ZSBzB0/edit?usp=sharing
login(server, 'root@stratpad.com', 'StratP@d')
with open ('/Users/woodj/Documents/projects/jstratpad/src/main/resources/banks/Accountants - acctg.csv', 'rb') as csvfile:
